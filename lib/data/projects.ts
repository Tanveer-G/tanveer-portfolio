...
export const PROJECTS: Project[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    desc: 'A production-quality dashboard for visualising and managing database service graphs — built with React 18, Vite 5, ReactFlow (xyflow), shadcn/ui, TanStack Query v5, and Zustand v4. Supports full light/dark mode switching.',
    tech: ['ReactFlow', 'msw', 'radix-ui', 'Vite 5', 'React 19', 'Zustand v4', 'TanStack Query v5'],
    img: '/projects/app-graph-builder.jpg',
    live: 'https://th-app-graph-builder.vercel.app/?utm_source=portfolio&utm_medium=website&utm_campaign=app-graph-builder',
    gh: 'https://github.com/th-app-graph-builder',
  }, 
    {
    id: 5,
  ...
  },
  {
    ...
    gh: 'https://github.com/Tanveer-G/The-Dubai-Mall-Interactive-Sales-Deck',
  }, 
  // {
  //   id: 7,
